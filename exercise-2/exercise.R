...
salaries_2018 <- salaries_2017 + runif(100, -5000, 1000)
...
raises <- nrow(salaries[salaries$got_raise == TRUE, ])
...
raise_name <- salaries[salaries$change == highest_raise, "Employees"]

# What was the largest decrease in salaries between the two years?
largest_decrease <- min(salaries$change)

# What was the name of the employee who recieved largest decrease in salary?
decrease_name <- salaries[salaries$change == largest_decrease, "Employees"]
